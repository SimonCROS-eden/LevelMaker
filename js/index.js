...
var perso = new Personnage(levels[actualLevel].getSpawnPoint(), new Location(10, 20), 'rgb(0, 161, 40)', ctx);
animation();

function animation() {
    levels[actualLevel].draw();
    showFPS();
    showLevel();
...
function showLevel() {
    ...
    ctx.fillText("Niveau " + (actualLevel + 1), canvas.width / 2, 26);
}
